package com.enestigli.cryptocrazy.presentation
...
import com.enestigli.cryptocrazy.presentation.CryptoList.CryptoListViewModel
...
fun CryptoListScreen(
    ...
    Surface(
        ...
        //Column alt alta yazilacaklar yapilacak seyler
      Column {
          Text("Crypto Crazy", modifier = androidx.compose.ui.Modifier
              .fillMaxWidth()
              .padding(20.dp),
...
fun CryptoList(navController: NavController,
    ...
    Box(contentAlignment = Alignment.Center, modifier = Modifier.fillMaxSize()){
        ...
        if(errorMessage.isNotEmpty()){
            //retryView tekrar deneme butonu gibi bir şey
...
fun CryptoListView(cryptos:List<CryptoListItem>,navController: NavController){
    //recyclerview gibi liste şeklinde göstermeye yarıyor.
